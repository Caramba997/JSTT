      ...
      try {
        ...
        response.data.on('data', (chunk) => {
          ...
          if ((currentLength / 10000) - lastUpdate > 1) {
            lastUpdate = (currentLength / 10000) - lastUpdate;
            const now = Date.now(),
            ...
            console.log(`${currentLength / 1000} kB / ~ ${totalLength} kB - ${remainingMins}:${remainingSecs >= 10 ? remainingSecs : `0${remainingSecs}`} remaining`);
          }
        });
